...
module BillBot1
  ...
  describe "#move" do
    ...
    describe "#move_valid" do
      ...
      it "should move to boundary from 2,2,NORTH" do
    ...
    describe "#move_at_boundary" do
      ...
      it "should ignore to move when place at 0,0,WEST" do
        bot.command("PLACE 0,0,WEST").should_not == nil
        bot.command("MOVE").should == nil
      end

      it "should stationary when place at 0,0,WEST and move" do
        bot.command("PLACE 0,0,WEST").should_not == nil
        bot.command("MOVE").should == nil
        bot.command("REPORT").should == "0,0,WEST"
      end

      it "should accept turn away from boundary" do
        bot.command("PLACE 0,0,WEST").should_not == nil
        bot.command("MOVE").should == nil
        bot.command("REPORT").should == "0,0,WEST"
