...
public class Service extends Inserter {
    ...
    public static int insert(Connection conn, int prodId, Product_service_type0 svc) {
        ...
        for (Row_type64 obj : svc.getRow()) {
            ...
            Service.insert(conn, prodId, svcId, obj.getProduct_service_configuration_relationship());
            Service.insert(conn, prodId, svcId,
    ...
    private static int insert(Connection conn, int prodId, int svcId,
        ...
        String cmd = "insert into t_product_service_configuration_relationship (product_id, minimum_capacity, attribute_id_service_config_definition, attribute_id_service_config, maximum_capacity, service_id, attribute_id_service_config_description, number_of_services) values (?, ?, ?, ?, ?, ?, ?, ?)";
        PreparedStatement pstmt;
        try {
            pstmt = conn.prepareStatement(cmd);
        } catch (SQLException e) {
    ...
    private static int insert(Connection conn, int prodId, int svcId,
        ...
        String cmd = "insert into t_product_service_external_system_relationship (service_id, external_system_text, product_id, external_system_code) values (?, ?, ?, ?)";
        PreparedStatement pstmt;
        try {
            pstmt = conn.prepareStatement(cmd);
        } catch (SQLException e) {
