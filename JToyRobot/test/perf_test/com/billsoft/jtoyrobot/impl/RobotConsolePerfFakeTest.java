...
/**
 * this class test console commanding performance with fake robot
 * 
 * @author bill
 * 
 */
public class RobotConsolePerfFakeTest extends PerfTestCase {

    private FakeRobot mBot;
    private RobotConsole mCon;

    public RobotConsolePerfFakeTest() {
        mBot = new FakeRobot();
    }
